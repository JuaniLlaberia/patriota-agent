...
4. Cargá las fuentes: `mcp_patriota_get_article_sources(article_id)`. No uses el `cluster_id`
   de otro artículo que estés procesando en el mismo lote — pedile las fuentes siempre por
   este `article_id` puntual.
